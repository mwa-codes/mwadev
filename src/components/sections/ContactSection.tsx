            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 px-4 sm:px-0">
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants}>
                            <motion.a
                                href="https://www.upwork.com/freelancers/~013354bbde519ce501?s=1110580755107926016"
                                target="_blank"
                                rel="noopener noreferrer"
                                whileHover={{ scale: 1.02 }}
                                whileTap={{ scale: 0.98 }}
                                className="block w-full p-6 bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl text-center text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                            >
                                <div className="flex items-center justify-center mb-2">
                                    ...
                                    <span className="text-xl">Hire me on Upwork</span>
                                </div>
                                <p className="text-green-100 text-sm">
                                    Professional freelance services • Full Stack Development specialist
                                </p>
                            </motion.a>
                        </motion.div>
