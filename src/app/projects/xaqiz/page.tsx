...
export const metadata: Metadata = {
    title: 'Xaqiz — Anonymous Confession AI Platform | Next.js, FastAPI, Supabase',
    description:
...
const schema = {
    ...
    "operatingSystem": "Web",
    "description": "Anonymous confession platform with AI transformations into creative formats.",
    "url": "https://mwadev.me/projects/xaqiz",
    "author": {
        "@type": "Person",
...
export default function Page() {
    const project = projects.find(p => p.slug === 'xaqiz');
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900">
            ...
            <Footer />
            <Script id="schema-softwareapp-xaqiz" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema).replace(/</g, '\\u003c') }} />
        </div>
    );
}
