...
export const metadata: Metadata = {
    title: 'BartanERP — Lightweight ERP for Manufacturers | React, FastAPI',
    description:
...
const schema = {
    ...
    "operatingSystem": "Web",
    "description": "Lightweight, modular ERP for small-scale manufacturing units to digitize daily operations.",
    "url": "https://mwadev.me/projects/bartanerp",
    "author": {
        "@type": "Person",
...
export default function Page() {
    const project = projects.find(p => p.slug === 'bartanerp');
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900">
            ...
            <Footer />
            <Script id="schema-softwareapp-bartanerp" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema).replace(/</g, '\\u003c') }} />
        </div>
    );
}
