...
export const metadata: Metadata = {
    title: 'AI Chatbot and Automation Development Services',
    description: 'Hire an AI developer for chatbots, document workflows, content processing, and OpenAI-powered automation.',
    alternates: {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900">
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-blue-600 dark:text-blue-400">AI Service</p>
                <h1 className="mt-3 text-4xl sm:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white">
                    Hire an AI Developer for Chatbots and Automation
                </h1>
                <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-3xl">
                    I build AI-powered workflows that help you answer users faster, process documents, and automate repetitive work.
                </p>
                ...
                <section className="mt-10 grid gap-6 md:grid-cols-2">
                    <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/60 p-6">
                        ...
                        <ul className="mt-4 space-y-2 text-gray-600 dark:text-gray-300 list-disc pl-5">
                            ...
                            <li>Document analysis pipelines</li>
                            <li>Internal automation tools</li>
                            <li>OpenAI and API integrations</li>
                        </ul>
                    </div>
                    <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/60 p-6">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">What you achieve</h2>
                        <ul className="mt-4 space-y-2 text-gray-600 dark:text-gray-300 list-disc pl-5">
                            <li>Faster support and content workflows</li>
                            <li>Clear business value from AI features</li>
                            <li>Less repetitive manual work</li>
                            <li>One page optimized for AI service searches</li>
                        </ul>
                    </div>
                </section>
                ...
                <section className="mt-10 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white">
                    ...
                    <p className="mt-3 text-blue-100">
                        QPDF and other AI-oriented work show how I handle document processing and AI product flows.
                    </p>
                    <div className="mt-5 flex flex-wrap gap-3">
                        <Link href="/projects/qpdf" className="rounded-lg bg-white px-4 py-2 font-semibold text-blue-700">
                            QPDF case study
                        </Link>
                        <Link href="/projects/xaqiz" className="rounded-lg border border-white px-4 py-2 font-semibold text-white">
                            Xaqiz case study
                        </Link>
                    </div>
                </section>
